<template>
  <div class="app-container" id="distributionManagement">
    <pageName></pageName>
    ...
    <el-table
      ...
      <el-table-column
        ...
        <template slot-scope="scope">
          <span class="details-btn" @click="toPage(scope)">查看</span>
        </template>
      </el-table-column>
    </el-table>
...
export default {
  ...
  methods: {
    toPage (item) {
      console.log(item)
      this.$router.push({
        name: 'distributionManagementDetails',
        query: {
          item
        }
      })
